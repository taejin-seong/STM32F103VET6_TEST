...
#define PI			  		 			 3.14f
#define DIAMETER 	 	     		 64.0f 							   							// 바퀴 지름  (mm 단위)
...
//#define RPM_TEST
#ifdef  RPM_TEST
#define ONE_ROTATION_PULSES  11			// 엔코더 축 PPR

#else
#define ENCODER_PULSES  	 	 11			// 엔코더 축 PPR

#endif /* RPM_TEST */

#define CIRCUMFERENCE 		 	 201.0f 	// 바퀴 원주(둘레) = 바퀴지름 * pi (mm 단위)
